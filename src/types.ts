export type Screen = 'login' | 'signup' | 'dashboard' | 'reports' | 'add' | 'settings' | 'add-income' | 'add-expense' | 'calculator' | 'reminders';

export type TransactionFrequency = 'none' | 'daily' | 'weekly' | 'biweekly' | 'monthly' | 'yearly';
...
export interface Category {
  ...
  initialDate?: string;
  frequency?: TransactionFrequency;
  lastProcessedDate?: string; // Track when it was last auto-generated
}
...
export const CATEGORIES: Category[] = [
  ...
  { id: 'insurance', name: 'insurance', icon: 'ShieldCheck', color: 'primary', isDefault: true, costType: 'fixed' },
  ...
  { id: 'consortium', name: 'consortium', icon: 'HandCoins', color: 'primary', isDefault: true, costType: 'fixed' },
  ...
  { id: 'maintenance', 
    ...
    subcategories: [
      ...
      'exhaust', 'transmissionKit', 'bearings', 'lubrication', 'clutch', 'tires',
      'fairing', 'brakePedal', 'gearPedal', 'rectification', 'cylinderHead', 'disc', 'crankcase'
    ]
  },
  { id: 'toll', name: 'toll', icon: 'Milestone', color: 'error', isDefault: true, costType: 'variable' },
  { id: 'washing', name: 'washing', icon: 'Waves', color: 'error', isDefault: true, costType: 'variable' },
  { 
    id: 'accessories', 
    name: 'accessories', 
    icon: 'Settings', 
  ...
  { id: 'rent', name: 'rent', icon: 'Key', color: 'primary', isDefault: true, costType: 'fixed' },
